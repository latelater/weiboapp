...
import com.sina.weibo.sdk.demo.WBSharaNaniActivity;
import com.sina.weibo.sdk.demo.WBShareToMessageFriendActivity;
import com.sina.weibo.sdk.demo.WBSocialActivity;
import com.sina.weibo.sdk.demo.WBStatisticActivity;
import com.sina.weibo.sdk.demo.openapi.WBOpenAPIActivity;
import com.sina.weibo.sdk.demo.openapi.WBStatus_sendAPIActivity;
...
public class WBDemoMainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nani);
        ...
        this.findViewById(R.id.feature_share).setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(WBDemoMainActivity.this, WBSharaNaniActivity.class));
            }
        });
        ...
        // 游戏入口
        this.findViewById(R.id.editweibo).setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                startActivity(new Intent(WBDemoMainActivity.this, WBStatus_sendAPIActivity.class));
            }
        });
        ...
        this.findViewById(R.id.feature_pay).setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(WBDemoMainActivity.this, mytestActivity.class));
            }
        });
