 ...
 * @since 2013-09-29
 */
public class WBSharaNaniActivity extends Activity {
    ...
    private void initialize() {
        ...
        ((Button) findViewById(R.id.register_app_to_weibo)).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(WBSharaNaniActivity.this,
        ...
        mShareButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(WBSharaNaniActivity.this, WBShareActivity.class);
